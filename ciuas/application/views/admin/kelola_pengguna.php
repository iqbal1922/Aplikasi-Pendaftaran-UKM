                        ...
                        <tbody>
                            <?php foreach ($pengguna as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning" onclick="edit_pengguna(<?php echo $row['id_user']; ?>)"><i class="fa fa-edit"></i> Edit</button>
    ...
    function reset(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.modal-footer').show();
                $('#form').attr('action', '<?php echo site_url('pengguna/reset_password'); ?>');
            },
            error: function(jqXHR, textStatus, errorThrown) {
                alert('Error get data from ajax' + jqXHR);
            }
                ...
                <div class="form-group" id="pengguna">
                    ...
                    <select name="id_siswa" id="" class="form-control">
                        <?php foreach ($mahasiswa as $row_mahasiswa) { ?>
                            <option value="<?php echo $row_mahasiswa['id_mahasiswa']; ?>"><?php echo $row_mahasiswa['nim']; ?>-<?php echo $row_mahasiswa['nama_mahasiswa']; ?></option>
                        <?php } ?>
                    </select>
                </div>
